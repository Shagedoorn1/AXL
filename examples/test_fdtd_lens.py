...
def main():
    ...
    style = Style(dark=True, font_size=9, cmap="inferno", grid=True, watermark="[::]$H.E.A.V.Y.")
    fig = plot_field(Ey=np.log10(fdtd.get_intensity() + 1e-12), grid=fdtd.grid, style=style)
